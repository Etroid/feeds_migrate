...
class AuthenticationFormPluginManager extends DefaultPluginManager {
  ...
  /**
   * Constructs a new Migrate Authentication Form Plugin Manager.
   *
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/migrate_plus/authentication/form', $namespaces, $module_handler, 'Drupal\feeds_migrate\MigratePluginFormInterface', 'Drupal\feeds_migrate\Annotation\AuthenticationForm');
